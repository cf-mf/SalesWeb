...
namespace SalesWeb.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            {
                return; //Não retorna nada pois o banco já está populado.
            }
            ...
            using (var transaction = _context.Database.BeginTransaction())
            {
                ...
                SalesRecord r1 = new SalesRecord(1, new DateTime(2025, 12, 25), 11000.0, SaleStatus.Billed, s1);
                SalesRecord r2 = new SalesRecord(2, new DateTime(2025, 12, 4), 7000.0, SaleStatus.Billed, s5);
                SalesRecord r3 = new SalesRecord(3, new DateTime(2025, 12, 13), 4000.0, SaleStatus.Canceled, s4);
                SalesRecord r4 = new SalesRecord(4, new DateTime(2025, 12, 1), 8000.0, SaleStatus.Billed, s1);
                SalesRecord r5 = new SalesRecord(5, new DateTime(2025, 12, 21), 3000.0, SaleStatus.Billed, s3);
                SalesRecord r6 = new SalesRecord(6, new DateTime(2025, 12, 15), 2000.0, SaleStatus.Billed, s1);
                SalesRecord r7 = new SalesRecord(7, new DateTime(2025, 12, 28), 13000.0, SaleStatus.Billed, s2);
                SalesRecord r8 = new SalesRecord(8, new DateTime(2025, 12, 11), 4000.0, SaleStatus.Billed, s4);
                SalesRecord r9 = new SalesRecord(9, new DateTime(2025, 12, 14), 11000.0, SaleStatus.Pending, s6);
                SalesRecord r10 = new SalesRecord(10, new DateTime(2025, 12, 7), 9000.0, SaleStatus.Billed, s6);
                SalesRecord r11 = new SalesRecord(11, new DateTime(2025, 12, 13), 6000.0, SaleStatus.Billed, s2);
                SalesRecord r12 = new SalesRecord(12, new DateTime(2025, 12, 25), 7000.0, SaleStatus.Pending, s3);
